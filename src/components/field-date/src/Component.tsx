									...
									<DatePicker
										...
										slotProps={{
											...
											textField: {
												...
												margin: `none`,
												// On the TextField slot, not the DatePicker: MUI X drops unknown
												// picker props, so an id there never reached the DOM and the
												// field could not be selected at all — fixed centrally.
												...({ 'data-test-id': testId ?? `id-wallet-field-date` } as Record<
													string,
													string
												>),
											},
...
Component.displayName = 'FieldDate'
