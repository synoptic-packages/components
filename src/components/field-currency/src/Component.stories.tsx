...
import { Component as FieldCurrency } from './Component'

const meta = {
	title: 'Form Fields/Field Currency',
...
} satisfies Meta<typeof FieldCurrency>
		...
		return (
			<div style={{ display: `flex`, flexDirection: `column`, gap: `16px`, minWidth: `300px` }}>
				<Form size={`small`} control={control} onSubmit={onSubmit}>
					{() => (
						<FormContent>
							<FieldCurrency name={`smallField`} size={`small`} control={control} />
							<FieldCurrency name={`normalField`} control={control} />
						</FormContent>
					)}
				</Form>
				<div
